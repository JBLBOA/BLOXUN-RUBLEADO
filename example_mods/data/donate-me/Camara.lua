                ...
                local yy = 570; -- Code to change the position of the camera up or down for the enemy Less = Down (They can be negative numbers), More = Up
                local xx2 = 820; -- Same code as above, but for boyfriend left, right
                local yy2 = 570; -- Same code as above, but for boyfriend up, down
                ...
                local ofs = 45; -- Code to adjust the intensity with which the camera moves, the more numbers, the more intense, and the fewer numbers, less intense
                ...
                function onStepHit()
                    if curStep == 256 then -- Camara de zoom BF
                        xx2 = 700
                        yy2 = 570
                        xx = 700
                        yy = 570
                    end
                    if curStep == 320 then -- Camara de zoom BF
                        xx2 = 820
                        yy2 = 570
                        xx = 600
                        yy = 570
                    end
                    if curStep == 896 then -- Camara de zoom BF
                        xx2 = 700
                        yy2 = 570
                        xx = 700
                        yy = 570
